...
$Logfile = "C:\Projetos\O365 & Infra\Rota do Oeste\Bit Titan"
...
if ($Connector.Count -eq 1)
{
	...
	$CSVPath = "C:\Projetos\O365 & Infra\Rota do Oeste\Bit Titan\Change-MW_ImportAddresses.csv" #"Please enter the path of your CSV file (example: C:\scripts\test.csv)"
